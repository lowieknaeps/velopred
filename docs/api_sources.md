...
- netwerk- of PCS-problemen (timeouts, lege responses) kunnen voorkomen; daarom gebruikt de Laravel HTTP-koppeling retries/backoff om tijdelijke issues op te vangen
