        ...
        <article className="vp-panel p-5 transition duration-300 hover:-translate-y-1 hover:shadow-[0_28px_80px_-40px_rgba(15,23,42,0.35)]">
            <div className="flex items-start justify-between gap-4">
                <div className="min-w-0">
                    <div className="break-words text-xs font-semibold uppercase tracking-[0.22em] text-slate-400">{rider.team}</div>
                    <h3 className="mt-2 break-words font-display text-2xl font-semibold tracking-tight text-slate-950">{rider.name}</h3>
                    <p className="mt-1 break-words text-sm text-slate-600">{rider.profile}</p>
                </div>
            ...
            <div className="mt-6 flex items-center justify-between gap-4">
                <div className="min-w-0">
                    ...
                    <div className="mt-1 break-words text-sm font-semibold text-slate-900">{rider.trend}</div>
                </div>
                <Link
