            ...
            <table className="w-full table-auto text-sm">
                <thead>
                    <tr className="border-b border-slate-100">
                        <th className="w-10 whitespace-nowrap pb-3 text-left text-xs font-semibold uppercase tracking-[0.2em] text-slate-400">#</th>
                        ...
                        <th className="w-32 whitespace-nowrap pb-3 text-right text-xs font-semibold uppercase tracking-[0.2em] text-slate-400">Winkans</th>
                        <th className="hidden w-24 whitespace-nowrap pb-3 text-right text-xs font-semibold uppercase tracking-[0.2em] text-slate-400 md:table-cell">Top-10</th>
                        <th className="hidden w-36 whitespace-nowrap pb-3 text-right text-xs font-semibold uppercase tracking-[0.2em] text-slate-400 xl:table-cell">Betrouwbaarheid</th>
                    </tr>
                </thead>
                <tbody className="divide-y divide-slate-50">
                    {rows.map((prediction) => (
                        ...
                        >
                            ...
                            <td className="hidden py-3 pr-4 text-slate-500 sm:table-cell">{prediction.team}</td>
                            <td className="py-3 text-right">
                                <div className="flex items-center justify-end gap-3">
                                    <div className="hidden w-24 sm:block">
                                        <ProbabilityBar value={prediction.win_probability} />
                                    </div>
                            ...
                            <td className="hidden py-3 text-right xl:table-cell">
                                <span
