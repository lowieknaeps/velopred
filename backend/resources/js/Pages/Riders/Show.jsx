            ...
            <div className="space-y-8">
                ...
                <section className="grid gap-6 lg:grid-cols-[1fr_0.8fr]">
                    <div className="vp-panel p-6 sm:p-8">
                        <div className="mb-4">
                            {rider.photo_url ? (
                                <div className="h-40 w-36 overflow-hidden rounded-2xl border border-slate-200 bg-slate-50 shadow-sm">
                                    <img
                                        src={rider.photo_url}
                                ...
                                <div className="flex h-40 w-36 items-center justify-center rounded-2xl border border-slate-200 bg-slate-50 text-sm font-semibold text-slate-500">
                                    Geen foto
                                </div>
                            )}
                        </div>
